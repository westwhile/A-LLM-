...
> **2026-07-20 状态更新：本页仅作历史记录，请勿继续签署。** 阶段 4–6 配置调整后，
> 本页登记的研究协议哈希已经过期；7 张必需 PIT 表也仍未补齐。请按
> [`真实PIT许可与人工签署执行指南.md`](真实PIT许可与人工签署执行指南.md) 完成预检，
> 并从 [`templates/真实PIT许可签署清单模板.md`](templates/真实PIT许可签署清单模板.md)
> 复制生成新的日期化签署页。
