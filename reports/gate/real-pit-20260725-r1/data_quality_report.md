...
- `daily_basic` `missing_rate:pe_ttm`: 0.002805 (Missing values in required field.)
- `daily_basic` `missing_rate:pb`: 0.079762 (Missing values in required field.)
- `daily_basic` `missing_rate:total_mv`: 0.030259 (Missing values in required field.)
- `daily_basic` `missing_rate:turnover_rate`: 0.113178 (Missing values in required field.)
- `daily_basic` `missing_rate:net_mf_amount`: 0.212982 (Missing values in required field.)
...
- `financial_indicator` `missing_rate:gross_margin`: 0.136315 (Missing values in required field.)
