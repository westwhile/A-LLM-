...
以下只是最小入口；完整的 30+ 篇分级论文库、学习阶段、知识清单和论文卡见 [R1 论文阅读与知识清单](../14_R1论文阅读与知识清单.md)。
...
工程实现与命令入口见 [R1 工程实施与人工闸门](../../../r1_engineering_guide.md)。当前工程底座可运行，但真实研究仍受文本许可、人工复核、模型选择和协议冻结门禁约束。
